...
if Spree::UserRegistrationsController.included_modules.exclude?(Reffiliate::UserRegistrationsControllerDecorator)
  Spree::UserRegistrationsController.prepend Reffiliate::UserRegistrationsControllerDecorator
end
